...
localStorage = localStoragePy('WatchMate', 'json')
...
def authenticate():
		...
		signup_titl_block.title("WatchMate")
		...
		if username and password and login_user(username,make_hashes(password)):
			...
			welcome_text_block.title("welcome To WatchMate")
			login_signup_image_block.image('./assets/images/movie.jpg')
